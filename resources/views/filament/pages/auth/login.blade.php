<div x-data="{
...
}" x-init="initHero()" class="fixed inset-0 flex min-h-screen text-left bg-slate-50 dark:bg-slate-950 z-50 overflow-hidden font-sans lg:h-screen transition-colors duration-300">
    ...
    <div class="hidden lg:block lg:w-1/2 h-full relative bg-[#001e40] overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-between h-full p-12 text-white">
            ...
            <div>
                <h2 class="text-3xl font-extrabold tracking-tight text-white leading-tight">Architecting the infrastructure of tomorrow's legacy.</h2>
                <p class="text-xs text-slate-300 mt-3 max-w-sm opacity-80 leading-relaxed">
                    Secure administrative gateway to monitor operations, manage platforms, and configure client environments.
                </p>
                <div class="flex items-center gap-2 mt-8">
                    <div class="h-0.5 w-8 bg-[#CC9933]"></div>
                    <span class="text-[10px] font-bold uppercase tracking-widest text-[#CC9933]">Command Center</span>
                </div>
            </div>
        </div>
        ...
        <div class="w-full max-w-md mx-auto my-auto py-10 z-10">
            <div class="bg-white dark:bg-[#0b1329] border border-slate-200/60 dark:border-white/5 shadow-2xl rounded-3xl p-8 md:p-10 space-y-6">
                <div>
                    ...
                    <p class="text-slate-400 dark:text-slate-400 text-xs">Authenticate your administrative access credentials.</p>
                </div>
