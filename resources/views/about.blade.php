...
@section('content')
    ...
    <section class="py-24 bg-white dark:bg-slate-950 border-b border-brand-borderLight dark:border-white/10">
        <div class="max-w-[1400px] mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-8">
    ...
    <!-- Core Values -->
    <section class="py-24 bg-white dark:bg-slate-950 border-b border-brand-borderLight dark:border-white/10">
        <div class="max-w-[1400px] mx-auto px-6 md:px-12 space-y-16">
            <div class="text-center space-y-3">
                <span class="text-brand-secondary font-bold text-xs uppercase tracking-widest block">Principles</span>
                <h2 class="font-display font-extrabold text-3xl text-brand-primary dark:text-white">Our Core Values</h2>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-brand-surfaceLight dark:bg-slate-900/40 p-8 rounded-2xl border border-brand-borderLight dark:border-white/10 flex flex-col justify-between hover-card-trigger shadow-sm">
                    <div class="space-y-4">
                        <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-slate-950 border border-blue-100 dark:border-white/10 flex items-center justify-center text-brand-primary dark:text-brand-secondary shrink-0">
                            <span class="material-symbols-outlined text-md">lightbulb</span>
                        </div>
                ...
                <div class="bg-brand-surfaceLight dark:bg-slate-900/40 p-8 rounded-2xl border border-brand-borderLight dark:border-white/10 flex flex-col justify-between hover-card-trigger shadow-sm">
                    <div class="space-y-4">
                        <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-slate-950 border border-blue-100 dark:border-white/10 flex items-center justify-center text-brand-primary dark:text-brand-secondary shrink-0">
                            <span class="material-symbols-outlined text-md">gavel</span>
                        </div>
                ...
                <div class="bg-brand-surfaceLight dark:bg-slate-900/40 p-8 rounded-2xl border border-brand-borderLight dark:border-white/10 flex flex-col justify-between hover-card-trigger shadow-sm">
                    <div class="space-y-4">
                        <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-slate-950 border border-blue-100 dark:border-white/10 flex items-center justify-center text-brand-primary dark:text-brand-secondary shrink-0">
                            <span class="material-symbols-outlined text-md">handshake</span>
                        </div>
                ...
                <div class="bg-brand-surfaceLight dark:bg-slate-900/40 p-8 rounded-2xl border border-brand-borderLight dark:border-white/10 flex flex-col justify-between hover-card-trigger shadow-sm">
                    <div class="space-y-4">
                        <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-slate-950 border border-blue-100 dark:border-white/10 flex items-center justify-center text-brand-primary dark:text-brand-secondary shrink-0">
                            <span class="material-symbols-outlined text-md">monitoring</span>
                        </div>
