...
@section('content')
    ...
    <section class="relative bg-brand-surfaceLight dark:bg-brand-surfaceDark overflow-hidden py-24 border-b border-brand-borderLight dark:border-white/10">
        ...
        <div class="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 text-center space-y-6">
            <span class="text-brand-secondary font-bold text-xs uppercase tracking-widest block">What we do &amp; How we help</span>
            <h1 class="font-display font-extrabold text-4xl md:text-5xl lg:text-6xl text-brand-primary dark:text-white max-w-3xl mx-auto leading-tight">
                Our Services
            </h1>
        ...
        <div class="max-w-[1400px] mx-auto px-6 md:px-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div x-show="activeTab === 'all' || activeTab === 'strategy'"
                    ...
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">insights</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'strategy'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">analytics</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'strategy'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">assignment</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'engineering'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">palette</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'engineering'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">code</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'engineering'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">phone_iphone</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'growth'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">settings_suggest</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'strategy'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">psychology</span>
                ...
                <div x-show="activeTab === 'all' || activeTab === 'growth'"
                     ...
                     class="bg-brand-surfaceLight dark:bg-slate-900/40 border border-brand-borderLight dark:border-white/10 p-8 rounded-2xl shadow-sm space-y-4 hover-card-trigger flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="material-symbols-outlined text-brand-primary dark:text-brand-secondary text-4xl">rocket_launch</span>
